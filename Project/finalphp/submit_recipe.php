...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Add this validation after the existing image upload code
if ($image_path) {
    ...
    $stmt = $conn->prepare("INSERT INTO recipes (user_id, title, description, ingredients, steps, cook_time, servings, difficulty, category, image_path) 
                           VALUES (:user_id, :title, :description, :ingredients, :steps, :cook_time, :servings, :difficulty, :category, :image_path)");
