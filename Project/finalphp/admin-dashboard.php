...
if (isset($_GET['delete_mail'])) {
    ...
    $delete_stmt = $conn->prepare("DELETE FROM support_mails WHERE id = ?");
    $delete_stmt->execute([$mail_id]);
    
    // Add activity log
    $username = $_SESSION['admin_username'];
    $activity_msg = "$username deleted a support mail";
    ...
    header("Location: admin-dashboard.php?tab=mails&success=Mail deleted successfully");
    exit();
}
                        ...
                        <?php foreach ($recipes as $recipe): ?>
                            <tr data-user="<?php echo htmlspecialchars($recipe['username']); ?>" data-recipe="<?php echo htmlspecialchars($recipe['title']); ?>">
                                ...
                                <td>
                                    ...
                                    <a href="recipe_detail.php?id=<?php echo $recipe['id']; ?>" class="action-btn approve">View</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
